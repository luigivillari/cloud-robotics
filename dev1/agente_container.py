...
log_file_path = "/app/logs/timing.log"  # Percorso del file di log
logging.basicConfig(
    filename=log_file_path,
    level=logging.INFO,  # Registra solo messaggi di livello INFO o superiore
...
def on_message(client, userdata, msg):
    ...
    if msg.topic == publish_topic:
        ...
        # Log dei tempi rilevanti (sostituisce i print)
        ...
        if response['agent_id'] == agent_id:
            if response['task']:
                ...
                try:
                    ...
                    # Log del tempo di avvio dei servizi (sostituisce i print)
